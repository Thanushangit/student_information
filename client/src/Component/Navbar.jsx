    ...
    <div>
        <nav className='py-2 px-5 md:py-4 md:px-10 bg-zinc-800 flex items-center justify-between fixed top-0 right-0 w-full'>
            ...
            <ul className=' items-center gap-10 text-lg font-semibold text-gray-300 hidden md:flex'>
                <li className='hover:cursor-pointer hover:text-gray-100 transition-all duration-200 text-gray-100'>Home</li>
                <li className='hover:cursor-pointer hover:text-gray-100 transition-all duration-200'>About</li>
                <li className='hover:cursor-pointer hover:text-gray-100 transition-all duration-200'>Contact</li>
            </ul>
        </nav>
    </div>
  )
